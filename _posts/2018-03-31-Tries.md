...
those pointers start to get filled up with references to other nodes and so on. 
       ...
       A..K..Z    <---- Here, each node of the root are represented
                        ...
                        **For example** inserting the letter 'a' from "acquiesce" 
                        will convert it to the value 0. These characters(a,b,c..) live at those indexs(0,1,2..)
                        since our root node will hold an array of indexes 0 through 25, 
                        and there are 26 possible slots for the 26 letters of the alphabet.
...
![](https://ww1.sinaimg.cn/large/73bd9e13ly1fof1u4iaorj2074074gp3.jpg)
